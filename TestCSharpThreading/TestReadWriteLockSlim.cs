...
namespace TestBasics
{
    ...
    { 
        static void Main()
        {
            ...
            // Execute a writer.
            var sc = new SynchronizedCache<int,string>();
            ...
            tasks.Add(Task.Run(() => {
                ...
                for (int ctr = 1; ctr <= sc.Count; ctr++)
                {
                    ...
                    if (value == "cucumber")
                        if (sc.AddOrUpdate(ctr, "green bean") != SynchronizedCache<int,string>.AddOrUpdateStatus.Unchanged)
